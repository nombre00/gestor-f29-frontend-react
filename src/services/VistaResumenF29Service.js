...
// función llamada en la página resumenAnualPrevisualizar.
export const exportarResumenAExcel3 = async (resumen, id_bd) => {
  // console.log('TT enviado:', resumen.TT);
  // console.log('ventas_detalle[3]:', resumen.ventas_detalle?.[33]);  // tipo 33, el que tiene datos
  // console.log('remuneraciones:', resumen.remuneraciones);
  try {
    const response = await api.post('/api/f29/resumen/exportar',{ resumen, id_bd },{ responseType: 'blob' })
