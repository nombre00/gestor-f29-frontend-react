    ...
    >
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        <li className="nav-item">
          <NavLink to="/inicio"
            className={({ isActive }) => `nav-link ${isActive ? 'active bg-white text-primary fw-bold' : 'text-white'}`}
          >
        ...
        <li className="nav-item">
          <NavLink to="/gestor-resumen-anual"
            className={({ isActive }) => `nav-link ${isActive ? 'active bg-white text-primary fw-bold' : 'text-white'}`}
          >
      ...
      <div className="mt-auto">
        <div className="dropdown">
          <button className="btn btn-link text-white dropdown-toggle text-decoration-none w-100 text-start"
